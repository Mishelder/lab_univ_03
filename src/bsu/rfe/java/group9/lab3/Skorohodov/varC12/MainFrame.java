...
public class MainFrame extends JFrame {
    ...
    public MainFrame(Double[] coefficients) {
        ...
        saveToCVSMenuItem = fileMenu.add( new AbstractAction("Сохранить в CSV-файл"){
        ...
        searchRangeMenuItem = tableMenu.add(new AbstractAction("Найти область многочлена") {
            public void actionPerformed(ActionEvent event) {
                String from =
                        JOptionPane.showInputDialog(MainFrame.this, "От: ",
                                "Поиск диапазона", JOptionPane.QUESTION_MESSAGE);
                String to =
                        JOptionPane.showInputDialog(MainFrame.this, "До: ",
                                "Поиск диапазона", JOptionPane.QUESTION_MESSAGE);
                String value = from + " " + to;
                renderer.setNeedleTwo(value);
                getContentPane().repaint();
            }
        });
